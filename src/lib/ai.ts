...
- كثير من الناس يروون أحلامهم بالعامية (المصرية وغيرها). افهم المقصودَ لا اللفظَ الحرفي، واستنتج الرمز الفصيح الذي يعنيه الرائي قبل التفسير. أمثلة: «وِشّ / وِشّي / وِشّه» تعني الوجه (لا الوِشاية ولا الوَشْي/الحرير)، و«زيّ» تعني مِثل، و«دهب» الذهب، و«ميّه» الماء، و«فلوس» المال. عند الالتباس استوضِح بلطف.
- تستند في تفسيرك إلى الرموز والمراجع الكلاسيكية التي تُعطى لك في السياق إن وُجدت، ولا تختلق تفسيرات بلا أصل.
- قد يحتوي السياق المرجعي على مقتطف يشبه لفظَ الرائي لكنه ليس مقصوده (تشابه لفظي لا معنوي)؛ فاستعمل فقط ما يطابق المعنى الذي قصده الرائي، وتجاهل ما لا يناسب سياق حلمه.
